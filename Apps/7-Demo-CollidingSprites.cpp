...
//#include "Text.h"
//
//string dir("C:/repos/SpaceRocks/SpaceRocks/Assets/Images/");
//string bgrnd = dir+"background.png";
//string pix1 = dir+"sun.png";
//string pix2 = dir+"shuttle.png";
...
//	sprite1.Initialize(pix1, .5f); sprite1.SetScale(.2f);
//	sprite2.Initialize(pix2, .6f); sprite2.SetScale(.2f);
//	sprite3.Initialize(pix3, .7f); sprite3.SetScale(.2f);
